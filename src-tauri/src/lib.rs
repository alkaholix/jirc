...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            script::script_notify,
            script::users_snapshot,
            script::users_set,
            script::users_remove,
            script::users_auto_toggle,
            script::users_auto_add,
            script::users_auto_remove,
            script::script_set_active,
            script::script_run_tabcomp,
            script::script_run_key,
            script::script_run_hotlink,
            script::script_dispatch_audio_end,
            ...
            script::script_set_client_compat_state,
            script::script_window_open,
            script::script_window_close,
            script::script_popups,
            script::script_run_popup,
            script::script_window_mouse,
            script::script_picture_read,
            script::script_picture_save,
            script::script_picture_snapshot,
            script::script_picture_binvar,
